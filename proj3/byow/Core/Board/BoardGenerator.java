...
/**
 * To start a game, you need a board. Given a random number a board generator
 * will generate a random board for you.
 * This board will have a random number of rooms that are randomly sized. Each
 * room is connected to at least one other
 * room via hallways.
 */
public class BoardGenerator {
    ...
    /**
     * This method will return a random door on the board that does not have a
     * neighbor. It will also only return a
    ...
    private boolean usablePlacementInstructions(RoomBuildPlans plans, Board board) {
        // This just checks to see of the board has space to build the new room. If
        // there isn't space, it likely means
