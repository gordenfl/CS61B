...
/**
 * A door is a temporary object used to help generate random boards. A door
 * exists on a side of a room, and can be
 * open or closed. A closed door appears visually as a wall. An open door
 * appears like a floor with walls on each
 * side. When a board is being generated, the BoardGenerator will select random
 * doors that are closed, and attempt
...
public class Door {
     ...
     * @param isOpen   boolean indicating if the door is open (in use) or closed
     *                 (not used)
     * @param side     indicates the side of the room that the door is on (e.g. top,
     *                 bottom, left, right)
    ...
    /**
     * For a given door, this method will return build instructions for a new room
     * or
     * hallway that connects to this door.
     * 
     * @return Build Instructions object = location for area + side that the door
     *         goes on.
     */
